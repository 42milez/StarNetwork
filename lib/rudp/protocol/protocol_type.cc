...
namespace rudp
{
    ...
    ConvertNetworkByteOrderToHostByteOrder(ProtocolType *cmd)
    {
        ...
        if (cmd_type == RUdpProtocolCommand::ACKNOWLEDGE) {
            cmd->acknowledge.received_reliable_sequence_number =
                ntohs(cmd->acknowledge.received_reliable_sequence_number);
            ...
            cmd->verify_connect.segment_throttle_acceleration =
                ntohl(cmd->verify_connect.segment_throttle_acceleration);
            cmd->verify_connect.segment_throttle_deceleration =
                ntohl(cmd->verify_connect.segment_throttle_deceleration);
            ...
            cmd->throttle_configure.segment_throttle_interval =
                ntohl(cmd->throttle_configure.segment_throttle_interval);
            cmd->throttle_configure.segment_throttle_acceleration =
                ntohl(cmd->throttle_configure.segment_throttle_acceleration);
            cmd->throttle_configure.segment_throttle_deceleration =
                ntohl(cmd->throttle_configure.segment_throttle_deceleration);
        }
