#ifndef STAR_NETWORK_LIB_RUDP_CHANNEL_H_
#define STAR_NETWORK_LIB_RUDP_CHANNEL_H_
...
namespace rudp
{
    class Channel
    {
      public:
        ...
        {
            core::LOG_DEBUG_VA("outgoing reliable sequence number was incremented (Channel): {0} -> {1}",
...
#endif // STAR_NETWORK_LIB_RUDP_CHANNEL_H_
